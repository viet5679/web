<%-- 
    Document   : Register
    Created on : Jan 17, 2025, 7:17:59 AM
    Author     : vuhuu
--%>
...
<html lang="en">
    ...
    <body class="bg-info">
        <a href="HomePage.jsp" id="back-to-home" class="btn btn-light btn-lg position-fixed" style="top: 20px; left: 20px; z-index: 1000;">
        ...
        <div class="container">
            ...
            <!-- Login Form Start -->
            <div class="row justify-content-center wrapper" id="login-box" style="display: none;">
                <div class="col-lg-10 my-auto myShadow">
                    <div class="row">
                        <div class="col-lg-7 bg-white p-4">
                        ...
                        <div class="col-lg-5 d-flex flex-column justify-content-center myColor p-4">
                            ...
                            <p class="text-center font-weight-bolder text-light lead">Enter your personal information and start your shopping journey with us!</p>
