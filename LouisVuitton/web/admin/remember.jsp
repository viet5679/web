...
<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/admin-html/remember.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Mar 2025 14:25:42 GMT -->
<head>
	<meta charset="utf-8">
										...
										<form class="forgot-form" method="post">
											<div class="input-control">
												<div class="imgcontainer user">
													<a href="index.jsp"><img src="assets/img/user/1.jpg" alt="user" class="user"></a>
												</div>
												<h6>John wilson</h6>
