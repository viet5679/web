...
<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/admin-html/apexchart.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Mar 2025 14:25:44 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
				...
				<div class="gi-header-items">
					...
					<div class="right-header">
						...
						<div class="gi-right-tool display-screen">
							<a class="gi-screen full" href="javascript:void(0)" title="Full Screen"><i class="ri-fullscreen-line"></i></a>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Mix Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
				...
				<div class="row">
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Line Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
				...
				<div class="row">
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Double Line Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
					...
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Dotted Line Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
				...
				<div class="row">
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">area Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
				...
				<div class="row">
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">bar Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
					...
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Live bar Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
				...
				<div class="row">
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Vertical bar Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
					...
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Vertical simple bar Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
							...
							<div class="gi-card-content">
								<div class="gi-chart-content">
									<div id="verticalSimpleBarChart"></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Candle Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
					...
					<div class="col-xl-6 col-md-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Boxplot Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
				...
				<div class="row">
					<div class="col-xl-4 col-md-6 col-sm-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Pie Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
					...
					<div class="col-xl-4 col-md-6 col-sm-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Radial Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
					...
					<div class="col-xl-4 col-md-6 col-sm-12">
						<div class="gi-card">
							<div class="gi-card-header split">
								<h4 class="gi-card-title">Donut Chart</h4>
								<div class="header-tools">
									<a href="javascript:void(0)" class="gi-full-card" title="Full Screen"><i
											class="ri-fullscreen-line"></i></a>
								</div>
	...
	<script src="assets/js/data/live-chart.jsp"></script>
</body>


<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/admin-html/apexchart.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Mar 2025 14:25:45 GMT -->
</html>
