...
<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/admin-html/buttons.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Mar 2025 14:25:45 GMT -->
<head>
	<meta charset="utf-8">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Default</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
								    <button class="gi-btn default-btn color-primary">Primary</button>
									<button class="gi-btn default-btn color-secondary">Secondary</button>
									<button class="gi-btn default-btn color-success">Success</button>
									<button class="gi-btn default-btn color-info">Info</button>
									<button class="gi-btn default-btn color-warning">Warning</button>
									<button class="gi-btn default-btn color-danger">Danger</button>
									<button class="gi-btn default-btn color-dark">Dark</button>
									<button class="gi-btn default-btn color-light">Light</button>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Default gradient</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
								    <button class="gi-btn gradient-btn color-primary-gradient">Primary</button>
									<button class="gi-btn gradient-btn color-secondary-gradient">Secondary</button>
									<button class="gi-btn gradient-btn color-success-gradient">Success</button>
									<button class="gi-btn gradient-btn color-info-gradient">Info</button>
									<button class="gi-btn gradient-btn color-warning-gradient">Warning</button>
									<button class="gi-btn gradient-btn color-danger-gradient">Danger</button>
									<button class="gi-btn gradient-btn color-dark-gradient">Dark</button>
									<button class="gi-btn gradient-btn color-light-gradient">Light</button>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Animated gradient</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
								    <button class="gi-btn gradient-animate-btn color-primary-gradient">Primary</button>
									<button class="gi-btn gradient-animate-btn color-secondary-gradient">Secondary</button>
									<button class="gi-btn gradient-animate-btn color-success-gradient">Success</button>
									<button class="gi-btn gradient-animate-btn color-info-gradient">Info</button>
									<button class="gi-btn gradient-animate-btn color-warning-gradient">Warning</button>
									<button class="gi-btn gradient-animate-btn color-danger-gradient">Danger</button>
									<button class="gi-btn gradient-animate-btn color-dark-gradient">Dark</button>
									<button class="gi-btn gradient-animate-btn color-light-gradient">Light</button>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">outline</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
								    <button class="gi-btn outline-btn color-primary">Primary</button>
									<button class="gi-btn outline-btn color-secondary">Secondary</button>
									<button class="gi-btn outline-btn color-success">Success</button>
									<button class="gi-btn outline-btn color-info">Info</button>
									<button class="gi-btn outline-btn color-warning">Warning</button>
									<button class="gi-btn outline-btn color-danger">Danger</button>
									<button class="gi-btn outline-btn color-dark">Dark</button>
									<button class="gi-btn outline-btn color-light">Light</button>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Default Radius</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
								    <button class="gi-btn radius-30 default-btn color-primary">Primary</button>
									<button class="gi-btn radius-30 default-btn color-secondary">Secondary</button>
									<button class="gi-btn radius-30 default-btn color-success">Success</button>
									<button class="gi-btn radius-30 default-btn color-info">Info</button>
									<button class="gi-btn radius-30 default-btn color-warning">Warning</button>
									<button class="gi-btn radius-30 default-btn color-danger">Danger</button>
									<button class="gi-btn radius-30 default-btn color-dark">Dark</button>
									<button class="gi-btn radius-30 default-btn color-light">Light</button>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">outline square</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
								    <button class="gi-btn radius-0 outline-btn color-primary">Primary</button>
									<button class="gi-btn radius-0 outline-btn color-secondary">Secondary</button>
									<button class="gi-btn radius-0 outline-btn color-success">Success</button>
									<button class="gi-btn radius-0 outline-btn color-info">Info</button>
									<button class="gi-btn radius-0 outline-btn color-warning">Warning</button>
									<button class="gi-btn radius-0 outline-btn color-danger">Danger</button>
									<button class="gi-btn radius-0 outline-btn color-dark">Dark</button>
									<button class="gi-btn radius-0 outline-btn color-light">Light</button>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Ripple Default</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
								    <button class="gi-btn ripple-default-btn color-primary">Primary</button>
									<button class="gi-btn ripple-default-btn color-secondary">Secondary</button>
									<button class="gi-btn ripple-default-btn color-success">Success</button>
									<button class="gi-btn ripple-default-btn color-info">Info</button>
									<button class="gi-btn ripple-default-btn color-warning">Warning</button>
									<button class="gi-btn ripple-default-btn color-danger">Danger</button>
									<button class="gi-btn ripple-default-btn color-dark">Dark</button>
									<button class="gi-btn ripple-default-btn color-light">Light</button>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Ripple</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
								    <button class="gi-btn ripple-btn color-primary">Primary</button>
									<button class="gi-btn ripple-btn color-secondary">Secondary</button>
									<button class="gi-btn ripple-btn color-success">Success</button>
									<button class="gi-btn ripple-btn color-info">Info</button>
									<button class="gi-btn ripple-btn color-warning">Warning</button>
									<button class="gi-btn ripple-btn color-danger">Danger</button>
									<button class="gi-btn ripple-btn color-dark">Dark</button>
									<button class="gi-btn ripple-btn color-light">Light</button>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Default Social</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
									<button class="gi-btn default-social-btn color-facebook"><i class="ri-facebook-line"></i><span>facebook</span></button>
									<button class="gi-btn default-social-btn color-twitter"><i class="ri-twitter-line"></i><span>Twitter</span></button>
									<button class="gi-btn default-social-btn color-linkedin"><i class="ri-linkedin-line"></i><span>Linkedin</span></button>
									<button class="gi-btn default-social-btn color-github"><i class="ri-github-line"></i><span>Github</span></button>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Social Icon</h4>
							</div>
							<div class="gi-card-content label-card">
								<div class="gi-buttons">
									<button class="gi-btn icon-social-btn color-facebook"><i class="ri-facebook-line"></i></button>
									<button class="gi-btn icon-social-btn color-twitter"><i class="ri-twitter-line"></i></button>
									<button class="gi-btn icon-social-btn color-linkedin"><i class="ri-linkedin-line"></i></button>
									<button class="gi-btn icon-social-btn color-github"><i class="ri-github-line"></i></button>
								</div>
							</div>
						</div>
					</div>
