...
<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/admin-html/typography.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Mar 2025 14:25:45 GMT -->
<head>
	<meta charset="utf-8">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Headings</h4>
							</div>
							<div class="gi-card-content label-card">
								...
								<div class="note">
									<p>font-family: "Nunito", sans-serif;</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							...
							<div class="gi-card-content label-card">
								<div class="gi-typo">
									<h1 class="color-primary">h1 - Class : color-primary</h1>
									<h2 class="color-secondary">h2 - Class : color-secondary</h2>
									<h3 class="color-success">h3 - Class : color-success</h3>
									<h4 class="color-info">h4 - Class : color-info</h4>
									<h5 class="color-warning">h5 - Class : color-warning</h5>
									<h6 class="color-danger">h6 - Class : color-danger</h6>
								</div>
								<div class="note">
									<p>font-family: "Nunito", sans-serif;</p>
								</div>
				...
				<div class="row">
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Paragraph</h4>
							</div>
							<div class="gi-card-content label-card detail-card">
								<div class="gi-typo">
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
										...
										book.</p>
									<ul>
										<li>1) Lorem Ipsum is simply dummy text</li>
										<li>2) printing and typesetting industry</li>
										<li>3) It is a long established fact</li>
										<li>4) There are many variations of passages</li>
										<li>5) Contrary to popular belief, Lorem Ipsum</li>
									</ul>
								</div>
								<div class="note">
									<p>font-family: "Poppins, sans-serif";</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Paragraph highlights</h4>
							</div>
							<div class="gi-card-content label-card detail-card">
								<div class="gi-typo">
									<p>Lorem Ipsum is <span class="color-primary">simply dummy</span> text of the
										printing and typesetting industry. Lorem Ipsum has been the <span
											class="color-secondary">industry's standard</span> dummy text ever since the
										1500s, when an unknown printer took a galley of type and scrambled it to make a
										type specimen book.</p>
									<ul>
										<li class="color-primary">1) Lorem Ipsum is simply dummy text</li>
										<li class="color-secondary">2) printing and typesetting industry</li>
										<li class="color-success">3) It is a long established fact</li>
										<li class="color-info">4) There are many variations of passages</li>
										<li class="color-warning">5) Contrary to popular belief, Lorem Ipsum</li>
									</ul>
								</div>
								<div class="note">
									<p>font-family: "Poppins, sans-serif";</p>
