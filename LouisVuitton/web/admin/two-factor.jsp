...
<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/admin-html/two-factor.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Mar 2025 14:25:42 GMT -->
<head>
	<meta charset="utf-8">
										...
										<form class="forgot-form" method="post">
											...
											<div class="input-control">
												...
												<div class="login-with-btns">
													<span class="already-acc">Return to<a href="signin.jsp" class="login-btn">Login</a></span>
												</div>
											</div>
										</form>
									</div>
