...
<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/admin-html/accordions.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Mar 2025 14:25:45 GMT -->
<head>
	<meta charset="utf-8">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Defoult</h4>
							</div>
								...
								<div class="accordion" id="accordionthree">
									...
									<div class="accordion-item">
										...
										<div id="collapsenine" class="accordion-collapse collapse"
											aria-labelledby="headingnine" data-bs-parent="#accordionthree">
											<div class="accordion-body">
					...
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header">
								<h4 class="gi-card-title">Colored</h4>
							</div>
							<div class="gi-card-content label-card">
					...
					<div class="col-xl-6">
						<div class="gi-card">
							<div class="gi-card-header tips">
								<h4 class="gi-card-title">Default</h4>
								<p class="small">(Multiple open)</p>
							</div>
							<div class="gi-card-content label-card">
								<div class="accordion">
									<div class="accordion-item">
							...
							<div class="gi-card-content label-card">
								<div class="accordion">
									<div class="accordion-item">
										...
										<div id="collapsefour" class="accordion-collapse color-primary collapse show">
											<div class="accordion-body">
												<strong>This is the first item's accordion body.</strong> It is shown by
												default, until the collapse plugin adds the appropriate classes that we
												use to style each element. These classes control the overall appearance,
									...
									<div class="accordion-item">
										<h2 class="accordion-header">
											<button class="accordion-button color-secondary collapsed" type="button"
												data-bs-toggle="collapse" data-bs-target="#collapsefive"
												aria-expanded="false" aria-controls="collapseTwo">
												Accordion Item #2
											</button>
										</h2>
										<div id="collapsefive" class="accordion-collapse color-secondary collapse">
											<div class="accordion-body">
												<strong>This is the second item's accordion body.</strong> It is hidden
												by default, until the collapse plugin adds the appropriate classes that
												we use to style each element. These classes control the overall
									...
									<div class="accordion-item">
										<h2 class="accordion-header" id="headingsix">
											<button class="accordion-button color-success collapsed" type="button"
												data-bs-toggle="collapse" data-bs-target="#collapsesix"
												aria-expanded="false" aria-controls="collapseThree">
												Accordion Item #3
											</button>
										</h2>
										<div id="collapsesix" class="accordion-collapse color-success collapse">
											<div class="accordion-body">
												<strong>This is the third item's accordion body.</strong> It is hidden
												by default, until the collapse plugin adds the appropriate classes that
												we use to style each element. These classes control the overall
