<%-- 
    Document   : MyAccount
    Created on : Jan 17, 2025, 1:21:57 AM
    Author     : vuhuu
--%>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="ProductList.jsp" class="nav-item nav-link">Products</a>
                            ...
                            <a href="MyAccount.jsp" class="nav-item nav-link">My Account</a>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" href="HomePage.jsp"><i class="fa fa-sign-out-alt"></i>Logout</a>
                        </div>
                    </div>
                    <div class="col-md-9">
