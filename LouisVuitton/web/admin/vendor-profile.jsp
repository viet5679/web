...
<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/admin-html/vendor-profile.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Mar 2025 14:25:41 GMT -->
<head>
	<meta charset="utf-8">
			...
			<div class="container-fluid">
				...
				<div class="row">
										...
										<div class="gi-vendor-block-img">
											<div class="gi-vendor-block-detail">
												...
												<div class="gi-settings">
													<a href="#" class="gi-btn-primary m-r-10">Edit Profile</a>
													<div class="dropdown">
					...
					<div class="col-xxl-9 col-xl-8 col-md-12">
						...
						<div class="gi-card vendor-profile">
							<div class="gi-card-content vendor-details mb-m-30">
