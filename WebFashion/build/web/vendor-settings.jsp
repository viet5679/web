...
<!-- Mirrored from maraviyainfotech.com/projects/ekka/ekka-v37/ekka-html/vendor-settings.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jan 2025 14:32:37 GMT -->
<head>
     <meta charset="UTF-8">
                        ...
                        <div class="ec-sidebar-block">
                            <div class="ec-vendor-block">
                                <div class="ec-vendor-block-items">
                                    <ul>
                                        <li><a href="vendor-dashboard.jsp">Dashboard</a></li>
                                        <li><a href="vendor-profile.jsp">Public Profile</a></li>
                                        <li><a href="vendor-uploads.jsp">Uploads</a></li>
                                        <li><a href="track-order.jsp">Track Shipping</a></li>
                                        <li><a href="vendor-settings.jsp">Settings (Edit)</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="ec-vendor-detail-block ec-vendor-block-contact">
                                                    <h6>Tax Information<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><i class="fi-rr-edit"></i></a></h6>
                                                    <ul>
