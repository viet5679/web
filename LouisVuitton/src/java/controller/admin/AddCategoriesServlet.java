 ...
 * @author adim
 */
@WebServlet(name = "AddCategoriesServlet", urlPatterns = {"/admin/add-categories"})
public class AddCategoriesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Map<Categories, Integer> categoryProductCountMap = new HashMap<>();
        for (Categories category : listCategory) {
            int totalProducts = pDao.getTotalProductByCategoryId(category.getId());
            categoryProductCountMap.put(category, totalProducts);
        }
