...
<html lang="en">
    ...
    <!-- Mirrored from maraviyainfotech.com/projects/ekka/ekka-v37/ekka-html/contact-us.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jan 2025 14:32:21 GMT -->
    <head>
        <meta charset="UTF-8">
    ...
    <body class="contact_us_page">
       ...
       <button onclick="removeFromCart('${item.productName}')">Remove</button>
        ...
        <!-- Ec Customer service start -->
        <section class="ec-customer-service section-space-mb">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="ec-customer-service-wrapper">
                            <h3 class="ec-service-title">How Can We Help You?</h3>
                            <p class="ec-service-text">
                                If you have any questions, feel free to contact our customer service team. We're here to assist you!
                            </p>

                            <!-- Contact Information -->
                            <div class="ec-service-contact">
                                <div class="ec-service-item">
                                    <h4>Phone Support</h4>
                                    <p>Call us: <a href="tel:0967870138">0967870138</a></p>
                                </div>
                                <div class="ec-service-item">
                                    <h4>Email Support</h4>
                                    <p>Email us: <a href="mailto:support@example.com">vietpthe180666@fpt.edu.vn</a></p>
                                </div>
