...
<!-- Mirrored from maraviyainfotech.com/wrapbootstrap/grabit-html/admin-html/vendor-update.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Mar 2025 14:25:41 GMT -->
<head>
	<meta charset="utf-8">
				...
				<form class="gi-profile-add">
					<div class="row">
								...
								<div class="col-xl-12">
									<div class="gi-card">
										<div class="gi-card-content">
											<div class="gi-vendor-block-img">
												<div class="gi-vendor-block-detail">
													...
													<div class="gi-settings">
														<a href="#" class="gi-btn-primary m-r-10">Add Profile</a>
						...
						<div class="col-xxl-9 col-xl-8 col-md-12">
							<div class="gi-card vendor-overview vendor-profile">
								<div class="gi-card-content gi-card-vendor vendor-details mb-m-30">
									<div class="row">
										<div class="col-sm-12">
											<h3>Account Details</h3>
											<div class="gi-vendor-detail">
