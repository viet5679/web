                        ...
                        <div class="align-self-center">
                            <div class="header-search">
                                <form class="ec-btn-group-form" action="shop" method="get">
                                    <input class="form-control ec-search-bar" name="text" placeholder="Search products..."
                                        type="text">
            ...
            <div class="container position-relative">
                <div class="row ">
                    ...
                    <div class="col">
                        <div class="header-search">
                            <form class="ec-btn-group-form" action="shop" method="get">
                                <input class="form-control ec-search-bar" name="text" placeholder="Search products..." type="text">
                                <button class="submit" type="submit"><i class="fi-rr-search"></i></button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 align-self-center">
                        <div class="ec-main-menu">
                            <ul>
                                ...
                                <li><a href="product-full-width.jsp">Track Order</a></li>
