...
public class DeleteCategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isDeleted = cd.deleteCategory(categoryID);
        if (isDeleted) {
            request.setAttribute("success", "Category deleted successfully!");
        } else {
            request.setAttribute("error", "Cannot delete category!");
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("add-categories").forward(request, response);
    }
